...
I think the experience could be improved by:
  1. Providing a clearer **week-by-week onboarding roadmap** (tools, documents, and expected learning milestones).  
  2. Adding more **short sharing sessions** on practical topics (best practices, reporting, communication, real project case studies).  
  3. Organizing more **team bonding/networking activities** to help interns connect with members across teams and feel even more integrated.
...
My suggestions are:
  - Create a centralized **Intern Handbook/Notion page** with key processes, FAQs, and writing guidelines for updates/reports.  
  - Hold a short **weekly sync** between interns and mentors/admins to quickly surface blockers and align expectations.  
  - Add a **mini demo/checkpoint** at the end of each phase so interns can present progress and receive early feedback.
